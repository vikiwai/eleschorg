...
Программа должна обеспечивать возможность выполнения перечисленных ниже функций
    ...
    * Индивидуальная настройка событий, в которые включаются базовые фильтры (школа, класс), а также свои личные фильтры. События можно перетаскивать и растягивать.
